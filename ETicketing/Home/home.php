      ...
      <div class="navigation">
        <nav class="menu">
          <ul>
            ...
            <li>
              <a href="../Seller/View/login.php">Seller Login</a>
              <a href="../User/View/login.php">User Login</a>
              <!-- <ul>
    ...
    <div class="banner-area">
      <div class="canvas">
        ...
        <div class="title1">
          ...
          <h1>We are here to make your journey pleasure and comfortable.</h1>
          <h3>
           You can make your journey memoriable
          </h3>
          <h3>Your decision our service.</h3>
